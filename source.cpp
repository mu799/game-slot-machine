...
void showGuide(bool show)
{
	...
	//printxy("< or > : Change bet", 15, 14, kind * 15, 0);
	//printxy("Enter : Place bet", 15, 16, kind * 15, 0);
}
...
void showAboutScene(bool show)
{
	...
	printxy("Nguyen Duong Hoang Duy", 29, 12, kind * 11, 0);
	printxy("KTPM2016 - UIT", 32, 14, kind * 7, 0);
